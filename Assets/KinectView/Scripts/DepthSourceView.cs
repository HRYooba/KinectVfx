...
public class DepthSourceView : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ViewMode == DepthViewMode.SeparateSourceReaders)
        {
            ...
            gameObject.GetComponent<Renderer>().material.SetTexture("_BaseColorMap", _ColorManager.GetColorTexture());
        ...
        else
        {
            ...
            gameObject.GetComponent<Renderer>().material.SetTexture("_BaseColorMap", _MultiManager.GetColorTexture());
    ...
    private void RefreshData(ushort[] depthData, int colorWidth, int colorHeight)
    {
        ...
        Color[] buffer = new Color[512 * 424];
        var colTex = _MultiManager.GetColorTexture().GetPixels();
